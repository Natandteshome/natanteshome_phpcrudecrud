...
<h2>Natan's Great Database</h2>
<a href="index.html">Home</a>
<br>This contains the database of employees with the last name Tsukuda</br>
<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'tesho012', 'tesho012', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date FROM employees where last_name = 'Tsukuda'";
